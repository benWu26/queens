import { getInvalidCells, autoInvalidateMultipleCells, removeInvalidationCause } from "shared";
import { boardType, cellType, cellGroupType } from "shared";
import rfdc from "rfdc";
const clone = rfdc();
import _ from "lodash";
import {cellChangeType, ruleFunctionType, boardGroupsType} from "shared"
// --------------------------- SOLUTION VALIDATION ------------------------------
